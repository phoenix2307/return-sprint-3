...
import {
    ActionTypes,
    addTaskAC, addTodolistInTasksReducerAC,
    changeTaskStatusAC,
    changeTitleTaskAC,
    deleteTaskAC,
    tasksReducer
...
test('status of specified task should be changed', () => {
    ...
    // expect(endState['todolistId2'][2].isDone).toEqual({
    //     todolistId1: [
    //         { id: '1', title: 'CSS', isDone: false },
    //         { id: '2', title: 'JS', isDone: true },
    //         { id: '3', title: 'React', isDone: false },
...
test('new array should be added when new todolist is added', () => {
    ...
    const endState = tasksReducer(startState, addTodolistInTasksReducerAC('new todolist'))
